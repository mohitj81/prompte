...
export default function HomePage() {
  ...
  const fetchFeaturedPrompts = useCallback(async () => {
    ...
    try {
      ...
      console.error(error)
      toast({ title: "Error", description: "Failed to load featured prompts.", variant: "destructive" })
    } finally {
  ...
  const fetchPopularCategories = useCallback(async () => {
    ...
    try {
      ...
      console.error(error)
      toast({ title: "Error", description: "Failed to load popular categories.", variant: "destructive" })
    } finally {
  ...
  const fetchStats = useCallback(async () => {
    ...
    try {
      ...
      console.error(error)
      toast({ title: "Error", description: "Failed to load platform statistics.", variant: "destructive" })
    } finally {
  ...
  const handleLike = async (promptId: string) => {
    try {
      ...
      toast({ title: data.isLiked ? "Liked!" : "Unliked!", description: data.isLiked ? "Prompt added to your likes." : "Prompt removed from your likes." })
    } catch (error) {
      console.error(error)
  ...
  const handleSave = async (promptId: string) => {
    try {
      ...
      const data = await res.json()
      toast({ title: data.isSaved ? "Saved!" : "Unsaved!", description: data.isSaved ? "Prompt added to your saved list." : "Prompt removed from your saved list." })
    } catch (error) {
      console.error(error)
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 text-gray-900 dark:text-white">
      ...
      {/* Hero Section */}
      <section className="relative w-full py-20 md:py-32 lg:py-40 overflow-hidden bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 text-center">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-700 dark:from-blue-400 dark:to-purple-500">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Button asChild className="px-8 py-3 text-lg rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg">
            <Link href="/explore">Explore Prompts</Link>
          </Button>
          <Button asChild variant="outline" className="px-8 py-3 text-lg rounded-full border-2 border-blue-500 text-blue-600 dark:border-blue-400 dark:text-blue-400 bg-transparent">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600">
        ...
        {loadingStats ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
            <Card className="flex flex-col items-center justify-center p-6 text-center shadow-lg border-0 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 dark:from-gray-900 dark:via-blue-900/10 dark:to-purple-900/10 backdrop-blur-sm">
            ...
            <Card className="flex flex-col items-center justify-center p-6 text-center shadow-lg border-0 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 dark:from-gray-900 dark:via-blue-900/10 dark:to-purple-900/10 backdrop-blur-sm">
              ...
              <p className="text-3xl font-bold">{stats.totalCategories.toLocaleString()}+</p>
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 py-8">Failed to load statistics.</p>
        )}
      </section>
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        ...
        {loadingPrompts ? (
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 py-12">No featured prompts yet.</p>
        ) : (
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 dark:from-blue-900 dark:to-purple-950 py-20 md:py-28 text-white text-center">
        <h2 className="text-3xl md:text-5xl font-extrabold mb-6">Ready to Create Your Next Masterpiece?</h2>
        ...
        <Button asChild className="px-10 py-4 text-xl rounded-full bg-white text-blue-700 hover:bg-gray-100 shadow-xl">
